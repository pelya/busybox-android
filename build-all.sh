...
export CFLAGS="-Os"
./build.sh $NDK x86-4.6 x86 4.6 android-14 `pwd`/build/x86 || exit 1
./build.sh $NDK arm-linux-androideabi-4.6 armeabi 4.6 android-14 `pwd`/build/arm || exit 1
./build.sh $NDK mipsel-linux-android-4.6 mips 4.6 android-14 `pwd`/build/mips || exit 1
